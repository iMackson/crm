...
from agents.mixins import LoginRequiredAndOrganizerMixin
...
class LeadCreateView(LoginRequiredAndOrganizerMixin, generic.CreateView):
    ...
    def form_valid(self, form: BaseModelForm) -> HttpResponse:
        ...
        html_message = loader.render_to_string(
            'leads/email_template.html',
            {
                'username': "admin",
                'subject': "Lead with was created successfully."
            }
        )
        send_mail(
...
class LeadUpdateView(LoginRequiredAndOrganizerMixin, generic.UpdateView):
...
class LeadDeletView(LoginRequiredAndOrganizerMixin, generic.DeleteView):
...
class AssignAgentView(LoginRequiredAndOrganizerMixin, generic.FormView):
